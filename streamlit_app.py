...
from _shared import show_logo, hero_logo, page_icon   # branding helpers

# ──────────────────────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="AGOI™ ESG Platform — Natural Eco Capital",
    page_icon=page_icon("🌍"),      # uses assets/icon.* or assets/logo.* if present
    layout="wide",
    initial_sidebar_state="expanded",
)
show_logo()   # sidebar logo on every page (no-op until a logo file is added)
...
# ──────────────────────────────────────────────────────────────────────────────
from _shared import logo_path   # noqa: E402

_HERO_TEXT = """
<div class="agoi-hero" style="margin-bottom:0">
  <h1>{title}</h1>
